  ...
  return (
    <main className="min-h-screen flex flex-col bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#1f3d47] via-[#0d1d23] to-[#09141a] text-white p-8">
      ...
      <div className="max-w-md mx-auto w-full flex-1 flex flex-col">
        <h1 className="text-3xl font-bold mb-8 px-2 tracking-tight">Register</h1>
        ...
        <div className="mt-12 text-center text-sm">
          ...
          <Link href="/login" className="text-[#62cdcb] border-b border-[#62cdcb]/30 font-medium hover:text-[#4599db] transition-colors">
            Login here
          </Link>
        </div>
      </div>
